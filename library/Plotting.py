...
class cv_colors(Enum):
    ...
    MINT = (239,255,66)
    YELLOW = (2,255,250)
def maximaldist(x1,x2,x3,x4):
    d1 = distance.euclidean(x1, x2)
    d2 = distance.euclidean(x2, x3)
    d3 = distance.euclidean(x3, x4)
    d4 = distance.euclidean(x1, x4)
    return np.amax([d1,d2,d3,d4])
...
def plot_3d_box(img, cam_to_img, ry, dimension, center):
    ...
    per = (box_3d[5][1] - box_3d[7][1])//6
    for i in range(0,7,2):
        cv2.line(img, (box_3d[i][0], box_3d[i][1]), (box_3d[i+1][0],box_3d[i+1][1]), cv_colors.GREEN.value, 1)
    
#     cv2.line(img, (box_3d[0][0], box_3d[0][1] - per), (box_3d[4][0],box_3d[4][1] - per), cv_colors.GREEN.value, 1)
#     cv2.line(img, (box_3d[1][0], box_3d[1][1] - per), (box_3d[5][0],box_3d[5][1] - per), cv_colors.GREEN.value, 1)
#     cv2.line(img, (box_3d[0][0], box_3d[0][1] - per), (box_3d[1][0],box_3d[1][1] - per), cv_colors.GREEN.value, 1)
#     cv2.line(img, (box_3d[4][0], box_3d[4][1] - per), (box_3d[5][0],box_3d[5][1] - per), cv_colors.GREEN.value, 1)

#     cv2.line(img, (box_3d[0][0], box_3d[0][1]), (box_3d[5][0],box_3d[5][1]), cv_colors.GREEN.value, 1)
#     cv2.line(img, (box_3d[4][0], box_3d[4][1]), (box_3d[1][0],box_3d[1][1]), cv_colors.GREEN.value, 1)
    print('Сoordinate of the center of mass (',(box_3d[0][0] + box_3d[5][0] + box_3d[4][0] + box_3d[1][0])//4,',',(box_3d[0][1] + box_3d[5][1] + box_3d[4][1] + box_3d[1][1])//4,')')
    front_mark = [(box_3d[i][0], box_3d[i][1]) for i in range(4)]
    cv2.circle(img, ((box_3d[0][0] + box_3d[5][0] + box_3d[4][0] + box_3d[1][0])//4, (box_3d[0][1] + box_3d[5][1] + box_3d[4][1] + box_3d[1][1])//4), 5, (0, 0, 255), -1)
...
#     print(box_3d[4][0],box_3d[4][1])
#     print(box_3d[5][0],box_3d[5][1])
#     print((box_3d[4][0] - box_3d[5][0]))
#     print((box_3d[4][0] - box_3d[5][0])**2)
    #print((box_3d[4][0] - box_3d[5][0])*(box_3d[4][0] - box_3d[5][0]),(box_3d[4][1] - box_3d[5][1])*(box_3d[4][1] - box_3d[5][1]))
#     print(sqrt((box_3d[4][0] - box_3d[6][0])**2 + (box_3d[4][1] - box_3d[6][1])**2),"!!!")
    return distance.euclidean([box_3d[7][0], box_3d[7][1]], [box_3d[5][0],box_3d[5][1]]),[(box_3d[0][0] + box_3d[5][0] + box_3d[4][0] + box_3d[1][0])//4,(box_3d[0][1] + box_3d[5][1] + box_3d[4][1] + box_3d[1][1])//4],maximaldist((box_3d[0][0], box_3d[0][1]),(box_3d[1][0], box_3d[1][1]),(box_3d[5][0], box_3d[5][1]),(box_3d[4][0], box_3d[4][1]))
